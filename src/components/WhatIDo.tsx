        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I build responsive and high-performing web applications using modern
                frontend tools and strong fundamental programming languages.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                I combine market research and strategic digital promotion to
                deliver user-focused solutions with measurable impact.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Responsive Web Design</div>
                <div className="what-tags">Digital Promotion</div>
                ...
                <div className="what-tags">Bengali</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
